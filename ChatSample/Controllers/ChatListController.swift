...
var messageTextKey = "message"
var peerNameKey = "name"
var peerTypeKey = "type"

class ChatListController: UITableViewController, BFTransmitterDelegate, ChatViewControllerDelegate {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.transmitter = BFTransmitter(apiKey: "edc55e06-10ef-40cf-a904-d93dbddbefeb")
        ...
        //Load data and register for background enter
        self.loadPeers()
    }
...
//            options = [.fullTransmission, .encrypted]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any!) {
        ...
        if segue.identifier == "openContactChat" {
            ...
            chatController.deviceType = DeviceType(rawValue: peerInfo["type"] as! String)!
...
//        let options: BFSendingOption = [.directTransmission, .encrypted]
    ...
    func processReceivedMessage(_ dictionary: Dictionary<String, Any>, fromUser user: String, byMesh mesh: Bool, asBroadcast broadcast: Bool) {
        ...
        if message.broadcast {
            ...
            let deviceType = DeviceType(rawValue: dictionary[peerTypeKey] as! String)!
    ...
    func processReceivedPeerInfo(_ peerInfo: Dictionary<String, Any>, fromUser user: String) {
        ...
        let receivedDeviceType = peerInfo[peerTypeKey] as! String
...
extension ChatListController {
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String {
        if section == onlineSection {
            return "Участники в сети"
        } else {
            return "Участники не в сети"
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let devType: DeviceType = DeviceType(rawValue: peerInfo["type"] as! String)!
        switch devType {
        case .undefined:
